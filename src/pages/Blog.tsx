    ...
    <Layout>
      <div className="container py-10 max-w-3xl">
        ...
        <div className="space-y-6">
          {posts.map((post) => (
            <article key={post.slug} className="group border border-border rounded-lg p-6 bg-card card-glow transition-all duration-300 hover:card-glow-hover hover:border-primary/30">
